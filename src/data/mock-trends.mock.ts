...
export const mockTrends: TrendBlog[] = [
  {
    id: 't001',
    title:
      'Quiet Luxury trên thị trường secondhand: khi “ít hơn” định giá trị cao hơn',
    ...
    authorBio:
      '10 năm theo dõi luxury & circular fashion tại châu Á–Thái Bình Dương.',
    publishedAt: '2025-11-02',
    updatedAt: '2025-11-08',
    wordCount: 1420,
    readingLevel: 'deep',
    coverCaption:
      'Tông trung tính & texture tự nhiên — nền tảng của Quiet Luxury trên nền tảng re-commerce.',
    tags: [
      'quiet-luxury',
      'curator-pick',
      'circular-fashion',
  ...
  },
  {
    id: 't002',
    title:
      'Grunge 90s tái xuất: từ runway đến chợ đồ cũ — cách săn đúng “mảnh ghép”',
    ...
    authorBio:
      'Phụ trách các series phối đồ từ kho Curator và street snap nội đô.',
    publishedAt: '2025-10-18',
    updatedAt: '2025-10-22',
    wordCount: 1180,
    readingLevel: 'medium',
    coverCaption:
      'Denim wash & layer flannel — combo được tìm kiếm nhiều nhất trên ModaMi Q3.',
    ...
    sources: [
      'LFW street recap · SS26 (tổng hợp)',
      'ModaMi Search Trends · keyword “flannel”',
    ],
    body:
  ...
  },
  {
    id: 't003',
    title:
      'Dopamine Dressing & tâm lý màu: áp dụng cho tủ đồ tái thương mại như thế nào?',
    ...
    readingLevel: 'light',
    coverCaption:
      'Sắc độ cao hoạt động tốt khi có một khối trung tính neo cân.',
    tags: ['dopamine-dressing', 'color-theory', 'pre-loved', 'wellmodamig'],
    keyTakeaways: [
    ...
    sources: [
      'Pantone Fashion Color Report (tóm tắt)',
      'PubMed · color & mood (popular science)',
    ],
    body:
  ...
  },
  {
    id: 't004',
    title:
      'Capsule 2025: mười “trụ cột” trong tủ đồ re-commerce — checklist Curator',
    ...
    readingLevel: 'medium',
    coverCaption:
      'Flatlay minh họa — các nhóm màu trung tính dễ luân chuyển giữa các mùa.',
    ...
    sources: [
      'UNEP · fashion waste factsheet',
      'ModaMi SKU longevity survey · draft',
    ],
    body:
